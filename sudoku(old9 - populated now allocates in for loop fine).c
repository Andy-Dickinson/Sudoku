...
void remove_numbers(int** grid, int remove, populated* remain_ref); // removes 'remove' amount of numbers from grid (based on difficulty)
...
srand(1);//////////////////////////////////////////////////////////////////////////
    ...
    remove_numbers(player_grid, 10, populated_list);
...
void remove_numbers(int** grid, int remove, populated* remain_ref) {
    int removed = 0;
